...
# starting points
    ...
    x=-xp             # x is a starting point, say from the far left point, [-xp...0...+xp] for SHO

    g_n_minus_1    =  2*m*(E-Potential(K,x    ))
    g_n            =  2*m*(E-Potential(K,x+h  ))
    g_n_plus_1     =  2*m*(E-Potential(K,x+2*h))

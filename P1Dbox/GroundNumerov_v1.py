...
def PlotParabolaPlus(Energies,XAll,PsiAll):
    ...
    for i in range(len(Energies)):
        print("Energy Level,v=",i+1," E = ", Energies[i])
        En=Energies[i]
...
#            Econverged.append(ee)
            ...
            # Acceptable solutions conditions
        ...
        delE = 0.05+delE/10 # since E is increased as E_n^2, we  can increase deltaE like this

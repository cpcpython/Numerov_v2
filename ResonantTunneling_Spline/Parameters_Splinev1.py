...
# Numerov Parameters
########################################################################
grid      = 24000        # N division from 0 to xp ie. grid number
global      gridshift    # An Important Parameter in Forward Numerov Method,

itern     = 15           # after this iteration program exit; if you want more levels increase it
...
xp        = 128.452          # range of oscillator as [0...xp] in atomic unit
Egap      = 0.01         # an empirical one to fit WFN at energy levels
#global node
node       =    0
nodeMax    =    7
EsearchMax =    0.18   # for plotting, y's limit  ie 4eV
Amp        =    0.5

...
# Numerov Parameters
########################################################################
grid      = 36000        # N division from 0 to xp ie. grid number
global      gridshift    # An Important Parameter in Forward Numerov Method,

itern     = 2000           # after this iteration program exit; if you want more levels increase it
...
xp        = +1.336545 #2.67309          # range of oscillator as [0...xp] in atomic unit
Egap      = 0.01         # an empirical one to fit WFN at energy levels
#global node
node       =    0
nodeMax    =    7
EsearchMax =    0.014     # for plotting, y's limit  ie 4eV
Amp        =    0.2
# for Display X Y Limt
windowx    =  [-1.336545,1.336545] #[0.0 ,xp]           # xmin-xmax
...
InEmin=0.0000                 # Starting E Minimum. it will automatically updated
InEmax=0.0001 # Starting E Maximum, it will automatically updated

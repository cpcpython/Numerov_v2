...
gshift = [[InEmin,2500],[5, 1000], [8, 500],[10,50]]
##################################################################################

# define Triangle well -  Potential function Here Zero-shifted asymptot is used
def Potential(x):
...
#---------------------------------------------------------------------------------
EsearchMax =     15.0               # for plotting, y's limit
itern      =     200                # after this iteration program exit; if you want more levels increase it
windowy    =    [0.,EsearchMax]     # ymin-ymax
